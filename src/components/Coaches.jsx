...
const coaches = [
  { src: '/assets/sensei/Sambath%20.JPG',             name: 'Sambath',          role: 'Head Sensei' },
  { src: '/assets/sensei/ADIL%20SALIM.jpg',           name: 'Adil Salim',       role: 'Coach' },
  { src: '/assets/sensei/ANARGHA%20.JPG',             name: 'Anargha',          role: 'Coach' },
  ...
  { src: '/assets/sensei/Akhil%20M%20.jpg',           name: 'Akhil M',          role: 'Coach' },
  { src: '/assets/sensei/Amal%20.jpg',                name: 'Amal',             role: 'Coach' },
  ...
  { src: '/assets/sensei/HAMDAN%20.JPG',              name: 'Hamdan',           role: 'Coach' },
  { src: '/assets/sensei/MAHEEN.JPG',                 name: 'Maheen',           role: 'Coach' },
  { src: '/assets/sensei/Rangan%20.jpg',              name: 'Rangan',           role: 'Coach' },
  { src: '/assets/sensei/SOORAJ%20S%20.JPG',          name: 'Sooraj S',         role: 'Coach' },
  ...
  { src: '/assets/sensei/Shaju%20S%20.JPG',           name: 'Shaju S',          role: 'Coach' },
  { src: '/assets/sensei/Shefeek%20.jpg',             name: 'Shefeek',          role: 'Coach' },
  { src: '/assets/sensei/Sooraj%20Santhosh%20.JPG',   name: 'Sooraj Santhosh',  role: 'Coach' },
  { src: '/assets/sensei/Sudheer%20S%20A%20.JPG',     name: 'Sudheer S A',      role: 'Coach' },
  { src: '/assets/sensei/Swathy%20.JPG',              name: 'Swathy',           role: 'Coach' },
  { src: '/assets/sensei/VISHNU.JPG',                 name: 'Vishnu',           role: 'Coach' },
  ...
  { src: '/assets/sensei/muhammed%20shajil%20.JPG',   name: 'Muhammed Shajil',  role: 'Coach' },
